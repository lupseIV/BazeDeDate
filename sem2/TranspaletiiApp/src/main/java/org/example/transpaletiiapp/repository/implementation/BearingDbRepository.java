...
public class BearingDbRepository implements BearingRepository {
    ...
    public Bearing save(Bearing entity) {
        ...
        try (Connection con = dbUtils.getConnection();
            ...
            throw new RepositoryException("Error saving Bearing", e);
        }
    }
    ...
    private Bearing update(Bearing entity) {
        ...
        try (Connection con = dbUtils.getConnection();
            ...
            throw new RepositoryException("Error updating Bearing", e);
        }
    }
    ...
    public List<Bearing> findAll() {
        ...
        try (Connection con = dbUtils.getConnection();
            ...
            throw new RepositoryException("Error fetching all Bearings", e);
        }
    }
    ...
    public void deleteById(UUID uuid) {
        ...
        try (Connection con = dbUtils.getConnection();
            ...
            throw new RepositoryException("Error deleting Bearing", e);
        }
    }
