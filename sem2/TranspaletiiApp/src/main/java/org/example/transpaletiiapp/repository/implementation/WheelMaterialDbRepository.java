...
public class WheelMaterialDbRepository implements WheelMaterialRepository {
    ...
    public WheelMaterial save(WheelMaterial entity) {
        ...
        try (Connection con = dbUtils.getConnection();
            ...
            throw new RepositoryException("Error saving WheelMaterial", e);
        }
    }
    ...
    private WheelMaterial update(WheelMaterial entity) {
        ...
        try (Connection con = dbUtils.getConnection();
            ...
            throw new RepositoryException("Error updating WheelMaterial", e);
        }
    }
    ...
    public List<WheelMaterial> findAll() {
        ...
        try (Connection con = dbUtils.getConnection();
            ...
            throw new RepositoryException("Error fetching all WheelMaterials", e);
        }
    }
    ...
    public void deleteById(UUID uuid) {
        ...
        try (Connection con = dbUtils.getConnection();
            ...
            throw new RepositoryException("Error deleting WheelMaterial", e);
        }
    }
